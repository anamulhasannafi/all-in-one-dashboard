    ...
    async function loadData() {
      try {
        ...
        if (p) {
          ...
          setBasePrice(p.basePrice !== null && p.basePrice !== undefined ? String(p.basePrice) : "");
          setComparePrice(p.comparePrice !== null && p.comparePrice !== undefined ? String(p.comparePrice) : "");
          setFabric(p.fabric || "");
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-3xl p-6 sm:p-8 ring-1 ring-rosewood-100/70 space-y-6">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            {imageUrl && (
              ...
              <img src={imageUrl} alt="Preview" className="h-20 w-20 rounded-xl object-cover ring-1 ring-rosewood-200 bg-cream-100 shrink-0" />
            )}
        ...
        <div className="border-t border-rosewood-100 pt-6">
          <div className="flex items-center justify-between mb-3">
            ...
            <label className="cursor-pointer inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-rosewood-100 text-rosewood-900 text-xs font-bold hover:bg-rosewood-200 transition">
        ...
        <div className="pt-4 flex items-center justify-end gap-3">
          ...
          <button
            type="submit"
            disabled={saving}
            className="inline-flex items-center gap-2 px-8 py-3 rounded-full bg-rosewood-800text-white text-sm font-bold hover:bg-rosewood-900 transition"
          >
